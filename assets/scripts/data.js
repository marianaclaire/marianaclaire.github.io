var story = {
	...
	content: {
		ENG: [
			...
			"So far I have unlocked my channeling and healing abilities, clairsentience, clairvoyance, clairaudience, clairscent, clairempathy and claircognizance . I am currently working on unlocking even more gifts but I know that patience and flow are my main purposes in this life so the abilities will come one by one.</p><p>During the 2015 shift, I had another awakening experience that inspired me to learn reiki and become a demi-vegetarian. More importantly, I stepped into the public eye to share my abilities with others.",
	...
	next:{
		ENG:'Next Chapter',
		FREN:'Chapitre suivant',
		ESP:'Siguiente capítulo'
	}
}
