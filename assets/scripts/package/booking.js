var data = {
    ...
    availability:{
        ENG:"My time zone is Mountain from Calgary, Canada: UTC-07:00/ MDT. To find out the difference between your time and my time zone before scheduling please visit: <a href='http://www.timeanddate.com/worldclock/converter.html' target='_blank'>timeanddate.com/worldclock/converter</a>.<br><br>Please message or email me to schedule your session to <a href='mailto:marianaclaireinfo@gmail.com'>marianaclaireinfo@gmail.com</a>.<br><br>If this is a gift please let me know in the email and I will send you a gift certificate. The person for whom the gift certificate is for can redeem it at any time.<br><br>Once you have schedule the session please proceed to pay for the session through the Paypal link.",
