var servicesFull = {
	...
	report:{
		...
		description:{
			ENG:[
				"<h3>1. Origin Report</h3>",
				"<h3>2. Aura Report</h3>",
				"<h3>3. Personal Channeling</h3>",
				"<h3>4. Relationship Report</h3>",
				"<h3>5. Spirit Team Report</h3>",
				"<h3>6. Aura Field Report</h3>",
				"<h3>7. Relationship Aura Field Report</h3>",
				"<h3>8. Past Life Short Story</h3>",
			],
			FREN:[
				"<h3>1. Rapport d’Origine Cosmique</h3>",
				"<h3>2. Rapport de l’Aura</h3>",
				"<h3>3. Canalisation Personnalisée</h3>",
				"<h3>4. Rapport de votre Relation</h3>",
				"<h3>5. Rapport de votre Équipe Spirituelle</h3>",
				"<h3>6. Rapport du Champs Aurique</h3>",
				"<h3>7. Rapport du Champs Aurique de votre Relation</h3>",
				"<h3>8. Histoire Courte de votre Vie Passée</h3>",
			],
			ESP:[
				"<h3>1. Reporte de Origen Cósmico</h3>",
				"<h3>2. Reporte Áurico</h3>",
				"<h3>3. Canalización Personalizada</h3>",
				"<h3>4. Reporte de su Relación</h3>",
				"<h3>5. Reporte de su Equipo Espiritual</h3>",
				"<h3>6. Reporte del Campo Áurico</h3>",
				"<h3>7. Reporte Áurico de su Relación</h3>",
				"<h3>8. Historia Corta de su Vida Pasada</h3>",
			]
		},
		color: "#9966FF",
		faIcon: "fa-file-o",
